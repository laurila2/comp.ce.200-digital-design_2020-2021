...
ARCHITECTURE struct OF tb_gamma IS
   ...
   COMPONENT bonus_t3_shield_gamma_set
   PORT (
      clk      : IN     std_logic ;
      rst_n    : IN     std_logic ;
      rx_rdy   : IN     std_logic ;
   ...
   FOR ALL : bonus_t3_shield_gamma_set USE ENTITY alien_game_lib.bonus_t3_shield_gamma_set;
