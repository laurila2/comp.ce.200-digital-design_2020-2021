-- VHDL Entity alien_game_lib.c2_t2_binary_to_one_hot_conventer.symbol
--
-- Created:
--          by - laurila2.laurila2 (linux-desktop8.tuni.fi)
--          at - 12:14:20 09/25/20
--
...
ENTITY c2_t2_binary_to_one_hot_conventer IS
   PORT( 
...
END c2_t2_binary_to_one_hot_conventer ;

--
-- VHDL Architecture alien_game_lib.c2_t2_binary_to_one_hot_conventer.tbl
--
-- Created:
--          by - laurila2.laurila2 (linux-desktop8.tuni.fi)
--          at - 12:21:55 09/25/20
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.3 (Build 4)
--
LIBRARY ieee;
USE ieee.std_logic_1164.all;
USE ieee.std_logic_arith.all;
ARCHITECTURE tbl OF c2_t2_binary_to_one_hot_conventer IS
